...
public class ResultsSingleQuestionDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_results_single_question_details);
...
//        imageView = findViewById(R.id.imageViewForTickSingleQuestion);
    ...
    private void getQuestionsList() {
        ...
        FireStore.collection(Constant.QUESTION_COLLECTION).whereEqualTo(Constant.QuestionCollectionFields.QUIZ_ID, docId)
            ...
            if (task.isSuccessful()) {
                ...
                Toast.makeText(ResultsSingleQuestionDetails.this, Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setCurrentQuestion() {
        ...
        option1.setText(questionList.get(questionNumber).getOption1());
        option2.setText(questionList.get(questionNumber).getOption2());
        option3.setText(questionList.get(questionNumber).getOption3());
        option4.setText(questionList.get(questionNumber).getOption4());
        ...
        switch (n) {
            case 1:
                ans = (questionList.get(questionNumber).getOption1());
//                option1.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
                option1.setBackgroundColor(Color.GREEN);
                break;
            case 2:
                ans = (questionList.get(questionNumber).getOption2());
//                option2.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
                option2.setBackgroundColor(Color.GREEN);
                break;
            case 3:
                ans = (questionList.get(questionNumber).getOption3());
//                option3.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
                option3.setBackgroundColor(Color.GREEN);
                break;
            case 4:
                ans = (questionList.get(questionNumber).getOption4());
//                option4.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
                option4.setBackgroundColor(Color.GREEN);
                break;
        }
        String QuestionId = questionList.get(questionNumber).getId();
        ...
        Query query = yourCollRef.whereEqualTo(Constant.QuizTakenQuestionsFields.QUIZ_TAKEN_ID, quizTakenId)
                .whereEqualTo(Constant.QuizTakenQuestionsFields.QUESTION_ID, questionList.get(questionNumber).getId());
        ...
        query.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (AttemptedAnswer[0] == null) {
                    Toast.makeText(ResultsSingleQuestionDetails.this, "Not attempted any answer", Toast.LENGTH_SHORT).show();
...
//                        imageView.setImageResource(R.drawable.ic_close_black_24dp);
                        if (AttemptedAnswer[0].equals(questionList.get(questionNumber).getOption1())) {
//                            option1.setBackgroundTintList(ColorStateList.valueOf(Color.RED));
                            option1.setBackgroundColor(Color.RED);
                        } else if (AttemptedAnswer[0].equals(questionList.get(questionNumber).getOption2())) {
//                            option2.setBackgroundTintList(ColorStateList.valueOf(Color.RED));
                            option2.setBackgroundColor(Color.RED);
                        } else if (AttemptedAnswer[0].equals(questionList.get(questionNumber).getOption3())) {
//                            option3.setBackgroundTintList(ColorStateList.valueOf(Color.RED));
                            option3.setBackgroundColor(Color.RED);
                        } else if (AttemptedAnswer[0].equals(questionList.get(questionNumber).getOption4())) {
