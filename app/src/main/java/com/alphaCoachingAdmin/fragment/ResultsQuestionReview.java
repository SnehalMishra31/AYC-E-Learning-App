...
import com.alphaCoachingAdmin.Score;
...
public class ResultsQuestionReview extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_results_question_review);
    ...
    private void getQuestionsList() {
        ...
        FireStore.collection(Constant.QUESTION_COLLECTION).whereEqualTo(Constant.QuestionCollectionFields.QUIZ_ID, docId)
            ...
            if (task.isSuccessful()) {
                ...
                Toast.makeText(ResultsQuestionReview.this, Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        query.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (AttemptedAnswer[0] == null) {
                    Toast.makeText(ResultsQuestionReview.this, "Not attempted any answer", Toast.LENGTH_SHORT).show();
        ...
        if (questionNumber < questionList.size() - 1) {
            ...
            documentReference.get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    Intent intent = new Intent(ResultsQuestionReview.this, Score.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("SCORE", (score) + "/" + (questionList.size()));
                    startActivity(intent);
                    ResultsQuestionReview.this.finish();
                }
            });
        }
    }
